...
# 强制添加 IDA Python 库路径（解决虚拟环境问题）
ida_python_paths = [
    "/Applications/IDA Professional 9.1.app/Contents/MacOS/python/3",
    "/Applications/IDA Professional 9.1.app/Contents/MacOS/python",
    "/Applications/IDA Pro 8.4/python/3",
    "/Applications/IDA Pro 8.4/python",
    "/Applications/IDA Pro 8.3/python/3",
    "/Applications/IDA Pro 8.3/python",
    "/opt/idapro/python/3",
    "/opt/idapro/python",
]
for p in ida_python_paths:
